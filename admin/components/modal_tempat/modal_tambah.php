<form action="" method="post">
        <div class="modal fade" id="AddModalTempat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input type="number" name="username" class="form-control username" value="">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm- mt-2">
                                <div class="form-group">
                                    <label>Makanan</label>
                                    <input type="text" name="username" class="form-control username" value="">
                                </div>
